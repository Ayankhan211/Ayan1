...
\033[1;94m ┈┈┈▕▕ABUBAKAR▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕B4 M4▏▏┈┈┈

\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈

\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mAYANKHAN.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
...
\033[1;91m☞ Auther     : ÅBUBAKAR_AYAN_M4_MASTER

\033[1;92m☞ WhatsApp   : 03232132362

\033[1;95m☞ YouTube    : https://https://youtube.com/channel/UCfm_y-Oq8A3G3lezQPF2uyA
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update ÅBUBAKAR_AYAN Tool')

	print (S + '[' + P + '☞3' + S + ']' + S + ' ÅBUBAKAR WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('Subscrib My Youtube Ayan TRICKS M4 MASTER✓')
